...
// end include: /tmp/tmpb3djqudf.js
// include: /tmp/tmpnomym_g7.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpnomym_g7.js
// include: /tmp/tmp2fe19deq.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp2fe19deq.js
...
var ASM_CONSTS = {
  166208: () => { if (document.fullscreenElement) return 1; },  
 166254: () => { return document.getElementById('canvas').width; },  
 166306: () => { return parseInt(document.getElementById('canvas').style.width); },  
 166374: () => { document.exitFullscreen(); },  
 166401: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 166474: () => { if (document.fullscreenElement) return 1; },  
 166520: () => { return document.getElementById('canvas').width; },  
 166572: () => { return screen.width; },  
 166597: () => { document.exitFullscreen(); },  
 166624: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 166757: () => { if (document.fullscreenElement) return 1; },  
 166803: () => { return document.getElementById('canvas').width; },  
 166855: () => { return parseInt(document.getElementById('canvas').style.width); },  
 166923: () => { if (document.fullscreenElement) return 1; },  
 166969: () => { return document.getElementById('canvas').width; },  
 167021: () => { return screen.width; },  
 167046: () => { if (document.fullscreenElement) return 1; },  
 167092: () => { return document.getElementById('canvas').width; },  
 167144: () => { return screen.width; },  
 167169: () => { document.exitFullscreen(); },  
 167196: () => { if (document.fullscreenElement) return 1; },  
 167242: () => { return document.getElementById('canvas').width; },  
 167294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 167362: () => { document.exitFullscreen(); },  
 167389: () => { return screen.width; },  
 167414: () => { return screen.height; },  
 167440: () => { return window.screenX; },  
 167467: () => { return window.screenY; },  
 167494: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 167547: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 167618: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 167675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 167746: () => { if (document.fullscreenElement) return 1; },  
 167792: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 167839;
var ___stop_em_js = Module['___stop_em_js'] = 167912;
